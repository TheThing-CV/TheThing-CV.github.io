...
BLOG_AUTHOR = "TheThing"  # (translatable)
BLOG_TITLE = "PythonAdventures"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://TheThing-CV.githubpages.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://TheThing-CV.githubpages.io/"
BLOG_EMAIL = "addictive.signals@gmail.com"
BLOG_DESCRIPTION = "Data adventures in the world of Python"  # (translatable)
